 ...
 */
@property (nonatomic, weak) id<AdobeUXImageEditorViewControllerDelegate> delegate;
...
typedef void(^AdobeImageEditorRenderCompletion)(UIImage *result, NSError *error);
