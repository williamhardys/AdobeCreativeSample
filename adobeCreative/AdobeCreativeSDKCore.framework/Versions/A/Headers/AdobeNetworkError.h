...
extern NSString *const AdobeNetworkRequestURLStringKey; /**< userInfo key returning an NSString* containing
                                                         * the url of the request that caused the error. */

extern NSString *const AdobeNetworkResponseHeadersKey;  /**< userInfo key returning an NSDictionary*
                                                         * containing the repsonse headers of the request
                                                         * that caused the error. */

extern NSString *const AdobeNetworkResponseDataKey;     /**< userInfo key returning an NSData* containing
                                                         * the data returned from the request that caused
                                                         * the error. */

extern NSString *const AdobeNetworkHTTPDebugIDKey;      /**< userInfo key returning an NSString containing
                                                         * the HTTP debug id returned by the request
                                                         * that caused the error. */
